...
[filename, pathname] = uigetfile({'params/params_RewardLeverPress_*.m'}, 'Please select animal specific params');
...
nHitsToStopIncreasingThreshold = params.nHitsToStopIncreasingThreshold;
...
while ESC
    ...
    if nHits > nHitsToStartIncreasingThreshold && nHits < nHitsToStopIncreasingThreshold
