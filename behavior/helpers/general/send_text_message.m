...
mail = 'surbehavior@gmail.com';    %Your GMail email address
password = 'aoejtkxqwjjlzufd';
% password = 'YeahThatsRight!';          %Your GMail password
% =========================================================================
if nargin == 3
    message = subject;
    subject = '';
...
switch strrep(strrep(lower(carrier),'-',''),'&','')
    ...
    case 'lyca';      emailto = strcat (number, '
end
